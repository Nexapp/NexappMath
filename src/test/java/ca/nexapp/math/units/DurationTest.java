...
public class DurationTest {
    ...
    @Test
    public void canCalculateTheAverage() {
	Duration tenSeconds = Duration.seconds(10);
	Duration twentySeconds = Duration.seconds(20);
	Duration sixtySeconds = Duration.seconds(60);

	Duration average = tenSeconds.average(twentySeconds, sixtySeconds);

	Duration expected = Duration.seconds(30);
